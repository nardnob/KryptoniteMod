...
public class KryptoniteFurnaceScreen extends ContainerScreen<KryptoniteFurnaceContainer> {
    ...
    public KryptoniteFurnaceScreen(final KryptoniteFurnaceContainer container, final PlayerInventory inventory, final ITextComponent title) {
    ...
    public void render(MatrixStack matrixStack, final int mouseX, final int mouseY, final float partialTicks) {
        ...
        final KryptoniteFurnaceTileEntity tileEntity = this.container.tileEntity;
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, final float partialTicks, final int mouseX, final int mouseY) {
        ...
        final KryptoniteFurnaceTileEntity tileEntity = container.tileEntity;
        if (tileEntity.smeltTimeLeft > 0) {
            // Draw progress arrow

...
public class GorillaEntityModel<T extends GorillaEntity> extends EntityModel<T> {
    ...
    public GorillaEntityModel() {
        ...
        butt_left.setTextureOffset(12, 35).addBox(-3.5F, -0.7608F, -0.5982F, 3.0F, 1.0F, 1.0F, 0.0F, false);
        butt_left.setTextureOffset(43, 34).addBox(-4.5F, 0.2392F, -0.5982F, 5.0F, 2.0F, 1.0F, 0.0F, false);
        butt_left.setTextureOffset(27, 2).addBox(-3.5F, 2.2392F, -0.5982F, 3.0F, 1.0F, 1.0F, 0.0F, false);
        ...
        butt_right.setTextureOffset(12, 33).addBox(1.5F, -2.1629F, -0.7828F, 3.0F, 1.0F, 1.0F, 0.0F, false);
        butt_right.setTextureOffset(28, 40).addBox(0.5F, -1.1629F, -0.7828F, 5.0F, 2.0F, 1.0F, 0.0F, false);
        butt_right.setTextureOffset(27, 0).addBox(1.5F, 0.8371F, -0.7828F, 3.0F, 1.0F, 1.0F, 0.0F, false);

        neck = new ModelRenderer(this);
        neck.setRotationPoint(0.0F, 9.5F, 1.0F);
        setRotationAngle(neck, -0.6981F, 0.0F, 0.0F);
        neck.setTextureOffset(43, 27).addBox(-2.0F, -3.5F, -0.5F, 4.0F, 4.0F, 3.0F, 0.0F, false);

        body = new ModelRenderer(this);
        body.setRotationPoint(0.0F, 15.25F, -2.0F);
        setRotationAngle(body, -0.9163F, 0.0F, 0.0F);
        body.setTextureOffset(0, 0).addBox(-5.0F, -6.9644F, -5.5321F, 10.0F, 13.0F, 7.0F, 0.0F, false);
        ...
        right_arm.setTextureOffset(34, 0).addBox(-1.0F, -7.5F, -3.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);
        right_arm.setTextureOffset(23, 28).addBox(-2.0F, 2.5F, -3.0F, 5.0F, 7.0F, 5.0F, 0.0F, false);

        left_arm = new ModelRenderer(this);
        left_arm.setRotationPoint(8.0F, 14.5F, 1.0F);
        left_arm.setTextureOffset(0, 33).addBox(-3.0F, -7.5F, -3.0F, 4.0F, 10.0F, 4.0F, 0.0F, false);
        left_arm.setTextureOffset(29, 15).addBox(-3.0F, 2.5F, -3.0F, 5.0F, 7.0F, 5.0F, 0.0F, false);

        left_leg = new ModelRenderer(this);
        left_leg.setRotationPoint(4.0F, 18.5F, -4.0F);
        left_leg.setTextureOffset(16, 40).addBox(-3.0F, -1.5F, -4.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);

        right_leg = new ModelRenderer(this);
        right_leg.setRotationPoint(-4.0F, 20.5F, -4.0F);
        right_leg.setTextureOffset(39, 39).addBox(-1.0F, -3.5F, -4.0F, 4.0F, 7.0F, 4.0F, 0.0F, false);
    }
